...
SET SRCDIR=src
SET BINDIR=bin
SET BINERR=a13server-javac.err
SET JARNAME=a13server.jar
SET JAROUT=a13server-jar.out
SET JARERR=a13server-jar.err
SET DOCDIR=doc
SET DOCPACK=game
SET DOCERR=a13server-javadoc.err
SET MAINCLASSSRC=src/server/ViewServer.java
SET MAINCLASSBIN=server.ViewServer
